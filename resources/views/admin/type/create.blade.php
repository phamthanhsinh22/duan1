                    ...
                    <div class="card-body">
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <form role="form" action="{{ route('type.store') }}" id="myTable" method="post">
                                    {{csrf_field()}}
                                    <div class="form-group">

                                        <label for="exampleInputEmail1">Nhập Type</label>
                                        <input type="text" onkeyup="ChangeToSlug()" id="slug" name="typName" class="form-control" id="exampleInputEmail1"
                                            placeholder="Vui lòng nhập...">
                                        <label for="exampleInputEmail1">Nhập slugType</label>
