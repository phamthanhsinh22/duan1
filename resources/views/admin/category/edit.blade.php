                    ...
                    <div class="card-body">
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <form role="form" action="{{ route('category.update', $category->id) }}" id="myTable"
                                    method="post">
                                    {{csrf_field()}}
                                    {{ method_field('PUT') }}
                                    <div class="form-group">
                                        ...
                                        <input type="text" onkeyup="ChangeToSlug()" id="slug" name="catName" class="form-control"
                                            id="exampleInputEmail1" value="{{ $category->catName }}">
                                        <label for="exampleInputEmail1">Nhập Slug</label>
                                        <input type="text" id="convert_slug" name="slug_cate" class="form-control" id="exampleInputEmail1"
                                            value="{{ $category->slug_cate }}">
